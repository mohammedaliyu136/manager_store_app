...
class EditShop extends StatefulWidget {
  EditShop(this.shop, this.position);
  Shop2 shop;
  int position;
  @override
  EditShopState createState() => EditShopState(shop, position);
}
class EditShopState extends State<EditShop> {
  Shop2 mShop;
  int position;
  EditShopState(this.mShop, this.position);
